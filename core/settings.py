...
SECRET_KEY = 'django-insecure--g%_zxgs-z)%m=j=_+opw%a^2f1lf1gdqebn7)ckpq)2fl@+2!'
...
JAZZMIN_SETTINGS = {
    ...
    # Bem-vindo texto de tea inicial
    'welcome_sign': 'Bem-vindo(a) ao SGP',

    # Copyright
    'copyright': 'Kalil LTDA',
